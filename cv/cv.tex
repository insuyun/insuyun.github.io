...
\begin{topic}{}{}
  \grant{브라우저용 변이 분석 보조 시스템 구축}{NRF}{65K}{PI}{23.06 -- 24.05}
  \grant{자바스크립트 중간 언어 기반 보안모델 생성 연구}{NSRI}{54.5K}{PI}{23.04 -- 23.10}
  \grant{개방형 OS 보안 위협 안전성 검증기술 연구}{NSRI}{54.5K}{PI}{23.04 -- 23.10}
  \grant{다종 커널 버그 분석 및 공격 코드 자동화 프레임워크 연구}{CISC}{100K}{PI}{23.02 -- 23.11}
  \grant{크로스 아키텍처의 정형 검증을 이용한 브라우저 퍼징}{NRF}{110K}{PI}{22.09 -- 23.09}
  \grant{취약점 탐지 검증용 테스트 케이스 구축}{ETRI}{27.3K}{PI}{22.08 -- 22.11}
  \grant{자바스크립트 엔진 안전성 분석을 위한 보안모델 생성 연구}{NSRI}{54.5K}{PI}{22.04 -- 22.10}
  \grant{이벤트 기반 실험시스템 구축을 통한 자동차 내·외부 아티팩트 수집 및 통합 분석 기술 개발}{단국대산학협력단}{300K $\times$ 0.5}{PI with Prof. Yujip Won}{22.04 -- 23.12}

  \grant{6G 보안기술연구}{Samsung Electronics}{200K $\times$ 0.2}{Co-PI with Prof. Yongdae Kim}{21.08 -- 23.09}
  \grant{DRAM Security 기술연구}{Samsung Electronics}{180K $\times$ 0.2}{Co-PI with Prof. Yongdae Kim}{21.07 -- 24.06}

  \grant{바이너리 분석을 위한 체계적이고 정확한 퀄컴 헥사곤 구조의 중간 표현 변환}{NRF}{46.7K}{PI}{21.06 -- 22.05}
  \grant{웹 브라우저 취약점 탐색을 위한 보안모델 자동 생성 연구}{NSRI}{54.5K}{PI}{21.04 -- 21.10}
  \grant{확장성 있는 사이버 추론 시스템의 개발 (Start-up)}{KAIST}{150K}{PI}{21.02 -- 24.12}
\end{topic}
